...
var resolve = {
    ...
    alias: {
        ...
        bjs: path.join(PATHS.libsPath, "bootstrap/js/bootstrap.js"),
        /*
         * css
         */
        bcss : path.join(PATHS.libsPath, "bootstrap/css/bootstrap.css"),
...
var entry = {
    index: './src/index.js',
    common: [
        path.join(PATHS.libsPath, "js/jquery.js"),
