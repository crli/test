...
var resolve = {
    ...
    alias: {
         ...
         * js
         */
        zepto: path.join(PATHS.libsPath, "js/zepto.mim.js"),
        /*
         * css
         */
        fcss : path.join(PATHS.libsPath, "css/zepto.fullPage.css"),
        acss: path.join(PATHS.libsPath, "css/animate.css"),
        icss: path.join(PATHS.srcPath, "css/index.scss"),
        gcss: path.join(PATHS.srcPath, "css/global.css"),
    }
}
...
var entry = {
    index: './src/index.js',
    common: [
        path.join(PATHS.libsPath, "js/zepto.min.js")
    ],
};
    ...
    config = Merge(
        config,
        {
            plugins: [
                ...
                new OpenBrowserPlugin({url: 'http://localhost:3000' + PATHS.publicPath + 'index.html'})
            ],
            devServer: {
                ...
                port: "3000", // Defaults to 3000   process.env.PORT
                proxy: {
                    '/devApi/': {
                        target: proxyTarget,
                        changeOrigin: true,
